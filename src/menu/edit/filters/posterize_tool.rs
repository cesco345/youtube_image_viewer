// src/menu/edit/filters/posterize_tool.rs
use fltk::{
...
use super::advanced::PosterizeFilter;

pub fn start_interactive_posterize(
    ...
    // Initialize crop selection for posterize area
                ...
                Event::Released => {
                    let should_apply = {
                        ...
                        if let Some((_, _, w, h)) = dimensions {
                            w > 5 && h > 5 && choice2(300, 300, "Apply posterize to selected area?", "Yes", "No", "") == Some(0)
                        } else {
                            false
                        }
                    };
